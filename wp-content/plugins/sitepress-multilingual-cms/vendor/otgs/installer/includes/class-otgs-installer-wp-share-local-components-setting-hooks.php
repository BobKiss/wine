...
class OTGS_Installer_WP_Share_Local_Components_Setting_Hooks {
	...
	private function get_model( $params ) {
		...
		return array(
			'strings'                    => array(
				...
				'radio_report_yes'        => __( 'Отправляйте информацию о темах и плагинах, чтобы быстрее получать поддержку и оповещения о совместимости.',
				                                 'installer' ),
				'radio_report_no'         => __( "Не отправляйте эту информацию и пропускайте уведомления о совместимости",
				                                 'installer' ),
	...
	private function validate_arguments( array $args ) {
		...
		$defaults = array(
			...
			'use_styles'                 => false,
			'use_radio'                  => false,
			'privacy_policy_text'        => __( 'Политика конфиденциальности и использования данных', 'installer' ),
			'plugin_site'                => null,
			'plugin_uri'                 => null,
		);
